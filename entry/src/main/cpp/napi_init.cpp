...
static napi_value invokeHspNative(napi_env env, napi_callback_info info)
{
    size_t argc = 2;
    napi_value args[2] = {nullptr};
    ...
    napi_create_double(env, hspNativeAdd(value0, value1), &sum);

    return sum;
}

static napi_value invokeHspArkTS(napi_env env, napi_callback_info info)
{
    size_t argc = 2;
    napi_value args[2] = {nullptr};
    ...
    return hspArkTSAdd(value0, value1);
}
